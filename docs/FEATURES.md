...
- **guardfile** / **specverb** / **opcore** / **codegen** / **cmd/specgen** - HTTP/codegen engine and packaged driver with `--project-root`. See [specgen.md](specgen.md) and [features-detail.md](features-detail.md).
