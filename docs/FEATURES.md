...
- **guardfile** / **specverb** / **opcore** / **codegen** / **cmd/specgen** - HTTP/codegen driver with `.specgen/` auto-discovery or explicit `--project-root`. See [specgen.md](specgen.md) and [features-detail.md](features-detail.md).
