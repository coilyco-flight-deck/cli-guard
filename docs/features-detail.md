...
- **guardfile**, **specverb**, **opcore** - Spec-driven verb subsystem and the frozen inline MCP proxy grammar. See [specverb.md](specverb.md) and [opcore-inline.md](opcore-inline.md).
