...
module github.com/coilysiren/cli-guard/scripts/gen-webdocs

go 1.25.0

require (
	github.com/coilysiren/cli-guard v0.0.0-00010101000000-000000000000
...
replace github.com/coilysiren/cli-guard => ../..
